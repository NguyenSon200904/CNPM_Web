  ...
  return (
    <div className="p-4">
      ...
      <div className="grid grid-cols-2 gap-4 h-[500px]">
        ...
        {/* Phần 2: Thông tin nhập hàng */}
        <div className="bg-white p-4 shadow rounded h-full flex flex-col overflow-y-auto">
          <h3 className="font-bold mb-2">Thông tin nhập hàng</h3>
          <div className="mb-2 flex items-center gap-2">
            <label className="font-semibold w-1/3">Mã phiếu nhập</label>
            <input
              type="text"
              value={receiptCode}
          ...
          <div className="mb-2 flex items-center gap-2">
            <label className="font-semibold w-1/3">Nhà cung cấp</label>
            <select
